...
/**
 * Enable, disable, or reorder authentication plugins.
 *
 * Replaces Moosh\Command\Moodle39\Auth\AuthManage.
 * Canonical name: auth:mod  |  Alias: auth-mod
 */
class AuthModCommand extends BaseCommand
{
