...
/**
 * Delete one or more activities from a course.
 *
 * Replaces Moosh\Command\Moodle39\Activity\ActivityDelete.
 * Canonical name: activity:delete  |  Alias: activity-delete
 */
class ActivityDeleteCommand extends BaseCommand
{
