...
run_moosh role:list -p "$MOODLE_PATH"
...
run_moosh role:list -p "$MOODLE_PATH" -o csv
...
run_moosh role:list -p "$MOODLE_PATH" -o json
...
run_moosh role:list -p "$MOODLE_PATH" -i
...
run_moosh role:list -p "$MOODLE_PATH" --help
...
run_moosh role:create -p "$MOODLE_PATH" testrole
...
run_moosh role:create -p "$MOODLE_PATH" testrole --name="Test Role" --run -o csv
...
run_moosh role:create -p "$MOODLE_PATH" testrole --run
EXIT_CODE=$?
...
run_moosh role:create -p "$MOODLE_PATH" testrole_arch --archetype=teacher --run -o csv
...
run_moosh role:create -p "$MOODLE_PATH" testrole_ctx --context=course,module --run -o csv
assert_output_contains "Context role created" "testrole_ctx" "$OUT"
echo ""

echo "--- Test: role:create archetype+context mutually exclusive ---"
run_moosh role:create -p "$MOODLE_PATH" testrole_bad --archetype=teacher --context=course --run
EXIT_CODE=$?
...
run_moosh role:create -p "$MOODLE_PATH" testrole_bad2 --context=invalid --run
EXIT_CODE=$?
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --name="Renamed Role"
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --name="Renamed Role" --run -o csv
assert_output_contains "Updated name in output" "Renamed Role" "$OUT"
echo ""

echo "--- Test: role:mod change description ---"
run_moosh role:mod -p "$MOODLE_PATH" testrole --description="A test description" --run -o csv
assert_output_contains "Role still in output" "testrole" "$OUT"
echo ""

echo "--- Test: role:mod set capability ---"
run_moosh role:mod -p "$MOODLE_PATH" testrole --capability "mod/forum:addnews=allow" --run -o csv
...
run_moosh role:mod -p "$MOODLE_PATH" testrole \
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --context-on=course,module --run -o csv
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --context-off=module --run -o csv
assert_output_not_contains "Context-off removed module" "module" "$OUT"
echo ""

echo "--- Test: role:mod no modifications error ---"
run_moosh role:mod -p "$MOODLE_PATH" testrole --run
EXIT_CODE=$?
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --capability "badformat" --run
EXIT_CODE=$?
...
run_moosh role:mod -p "$MOODLE_PATH" testrole --capability "mod/forum:addnews=badperm" --run
EXIT_CODE=$?
...
run_moosh role:mod -p "$MOODLE_PATH" nonexistentrole --name="X" --run
EXIT_CODE=$?
...
run_moosh role:mod -p "$MOODLE_PATH" --help
...
run_moosh role:export -p "$MOODLE_PATH" student
...
run_moosh role:export -p "$MOODLE_PATH" student --pretty
...
echo \$r->id;
" 2>/dev/null)
run_moosh role:export -p "$MOODLE_PATH" "$STUDENT_ID"
...
run_moosh role:export -p "$MOODLE_PATH" nonexistentrole
EXIT_CODE=$?
...
run_moosh role:export -p "$MOODLE_PATH" --help
...
run_moosh role:import -p "$MOODLE_PATH" "$TMPDIR/testrole_export.xml"
...
run_moosh role:import -p "$MOODLE_PATH" "$TMPDIR/testrole_export.xml" --run --skip-validate
...
run_moosh role:import -p "$MOODLE_PATH" --run
EXIT_CODE=$?
...
run_moosh role:import -p "$MOODLE_PATH" --help
...
run_moosh role:reset -p "$MOODLE_PATH" student "$TMPDIR/student_baseline.xml"
...
run_moosh role:reset -p "$MOODLE_PATH" student "$TMPDIR/student_baseline.xml" --run
...
run_moosh role:reset -p "$MOODLE_PATH" nonexistentrole "$TMPDIR/student_baseline.xml" --run
EXIT_CODE=$?
...
run_moosh role:reset -p "$MOODLE_PATH" student /nonexistent/file.xml --run
EXIT_CODE=$?
...
run_moosh role:reset -p "$MOODLE_PATH" --help
...
run_moosh role:delete -p "$MOODLE_PATH" testrole
...
run_moosh role:delete -p "$MOODLE_PATH" testrole --run
...
run_moosh role:delete -p "$MOODLE_PATH" delme1 delme2 --run
...
run_moosh role:delete -p "$MOODLE_PATH" nonexistentrole --run
EXIT_CODE=$?
...
run_moosh role:delete -p "$MOODLE_PATH" --help
