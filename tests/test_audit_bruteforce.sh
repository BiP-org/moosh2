...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=10
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=10 -o csv
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=10 -o json
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=3 -o csv
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=100
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --min-attempts=3 --ip=10.0.0.100 -o csv
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --days=0 --min-attempts=1
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --targeted-users -o csv
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --password-policy
...
run_moosh audit:bruteforce -p "$MOODLE_PATH" --help
