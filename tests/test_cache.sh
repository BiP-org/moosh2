...
run_moosh cache:purge -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:purge --store default_application -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:purge --store nonexistent -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:purge --definition core/coursemodinfo -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:purge --store default_application --definition core/coursemodinfo -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:purge -p "$MOODLE_PATH" --help
...
run_moosh cache:rebuild 2 -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:rebuild --all -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:rebuild -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:rebuild 999 -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:rebuild -p "$MOODLE_PATH" --help
...
echo "--- Test: Show all ---"
run_moosh cache:info -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:info --stores -p "$MOODLE_PATH"
...
run_moosh cache:info --definitions -p "$MOODLE_PATH"
...
run_moosh cache:info --mappings -p "$MOODLE_PATH"
...
echo "--- Test: Dry run ---"
run_moosh cache:create file teststore -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:create file testfilestore -p "$MOODLE_PATH" --run
EC=$?
...
run_moosh cache:create nonexistent mystore -p "$MOODLE_PATH" --run
EC=$?
...
echo "--- Test: CSV output ---"
run_moosh cache:create file csvstore -p "$MOODLE_PATH" --run -o csv
...
run_moosh cache:create -p "$MOODLE_PATH" --help
...
run_moosh cache:mod --application testfilestore -p "$MOODLE_PATH"
EC=$?
assert_exit_code "Dry run exit code 0" 0 $EC
assert_output_contains "Shows dry run" "Dry run" "$OUT"
...
run_moosh cache:mod --application testfilestore -p "$MOODLE_PATH" --run
EC=$?
...
run_moosh cache:mod --definition "$DEF_ID" --store testfilestore -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:mod --definition "$DEF_ID" --store testfilestore -p "$MOODLE_PATH" --run
EC=$?
...
run_moosh cache:mod -p "$MOODLE_PATH"
EC=$?
...
run_moosh cache:mod --definition core/coursemodinfo -p "$MOODLE_PATH" --run
EC=$?
...
run_moosh cache:mod --application nonexistent -p "$MOODLE_PATH" --run
EC=$?
assert_exit_code "Exit code 1 for invalid store" 1 $EC
assert_output_contains "Error for invalid store" "not found" "$OUT"
echo ""
...
run_moosh cache:mod --definition fake/definition --store testfilestore -p "$MOODLE_PATH" --run
EC=$?
...
run_moosh cache:mod -p "$MOODLE_PATH" --help
