...
run_moosh course:last-visited -p "$MOODLE_PATH" 2 -o csv
...
run_moosh course:last-visited -p "$MOODLE_PATH" 2 3 4 -o csv
...
run_moosh course:last-visited -p "$MOODLE_PATH" 2 -o json
...
run_moosh course:last-visited -p "$MOODLE_PATH" 99999
EXIT_CODE=$?
...
echo "--- Test: Help ---"
run_moosh course:last-visited -p "$MOODLE_PATH" --help
